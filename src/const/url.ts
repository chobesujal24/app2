...
export const UTM_SOURCE = 'qyvera_ai';

export const OFFICIAL_URL = 'https://qyvera.web.app/';
export const OFFICIAL_PREVIEW_URL = 'https://qyvera.web.app/';
export const OFFICIAL_SITE = 'https://qyvera.web.app/';

export const getCanonicalUrl = (path: string) => urlJoin(OFFICIAL_URL, path);

export const OG_URL = '/og/cover.png?v=1';

export const GITHUB = 'https://github.com/qyvera/qyvera-ai';
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = urlJoin(GITHUB, 'blob/main/CHANGELOG.md');
export const DOCKER_IMAGE = 'https://hub.docker.com/r/qyvera/qyvera-ai';
...
export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/qyvera/qyvera-ai/discussions';
...
export const EMAIL_SUPPORT = 'support@qyvera.com';
export const EMAIL_BUSINESS = 'hello@qyvera.com';

export const MEDIDUM = 'https://medium.com/@qyvera';
export const X = 'https://x.com/qyvera';
