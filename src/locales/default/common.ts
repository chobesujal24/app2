export default {
  ...
  footer: {
    ...
    feedback: {
      action: '分享反馈',
      desc: 'Every thought and suggestion is valuable to us. We can\'t wait to hear from you! Please contact us to provide product feature and user experience feedback to help us build Qyvera AI better.',
  ...
  telemetry: {
    allow: '允许',
    deny: '拒绝',
    desc: 'We would like to anonymously collect your usage information to help us improve Qyvera AI and provide you with a better product experience. You can turn it off at any time in Settings > About.',
    learnMore: '了解更多',
    title: 'Help Qyvera AI get better',
  },
  temp: '临时',
  terms: '服务条款',
  updateAgent: '更新助理信息',
